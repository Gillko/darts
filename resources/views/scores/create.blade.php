...
<div class="container">
    <div class="row">
        <div id="scoreboard" class="ui-sortable">
            <div class="col-md-6">
                @foreach($players as $player)
                   <div class="col-md-12 col-12 player" id="player">
                      <div class="row points-player hide" id="points-player">
                         <div class="col-md-6 col-6" id="points-name"></div>
                         <div class="col-md-6 col-6" id="points-minus-log"></div>
                      </div>
                      <div class="board">
                         <div class="row">
                            <div class="col-md-6 col-sm-6 col-6">
                               <h2 id="player">{{ $player->nickname }}</h2>
                            </div>
                            <div class="col-md-6 col-sm-6 col-6" id="point-input">
                                <input class="form-control form-control-points score-value" id="score-value" value="301" disabled="">
                            </div>
                         </div>
